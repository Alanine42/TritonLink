...
<%
    ...
    String _concentrations = request.getParameter("concentrations");
    ...
    if (action != null && action.equals("insert")) {
      ...
      pstmt.setString(8, _concentrations);
    ...
    if (action != null && action.equals("update")) {
      ...
      PreparedStatement pstmt = conn.prepareStatement(
          "update masters set fname=?, mname=?, lname=?, ssn=?, residency=?, department=?, concentrations=? where student_id=?");
      ...
      pstmt.setString(7, _concentrations);
      pstmt.setString(8, _student_id);     // fill in the student_id wildcard
    ...
    if (action != null && action.equals("delete")) {
      ...
      PreparedStatement pstmt = conn.prepareStatement(
          "delete from masters where student_id=?");
    ...
    response.sendRedirect("index.jsp?type=masters");  // avoid refresh = re-insertion
...
<% 
  while (rs.next()) { 
    ...
    String concentrations = rs.getString("concentrations");
%>
